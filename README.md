...
- [웹 시연 페이지](https://blendery5.netlify.app/)를 통해 서버에서 제공하는 API를 직접 시험해볼 수 있습니다. 로그인을 위한 이메일과 비밀번호는 부스에 있는 서버 담당자(최혁진)에게 문의해 주세요.
...
- 메뉴 이름뿐 아니라 초성으로도 검색할 혀수 있도록 검색을 위한 별도의 필드를 함께 관리하고 있습니다.
...
| **Framework & ORM** | ![Spring Boot](https://img.shields.io/badge/Spring_Boot-4.0-6DB33F?style=for-the-badge&logo=springboot&logoColor=white) ![Hibernate](https://img.shields.io/badge/Hibernate-ORM-59666C?style=for-the-badge&logo=hibernate&logoColor=white) |
...
- Blendery는 현재 MVP 단계로, 실제 매장 환경에서의 사용 가능성을 검증하는 데 집중해 구현되었습니다. 그 과정에서 일부 기능은 의도적으로 제외하거나 단순화했습니다.
  ...
  2. 이메일 인증 단계 추가
     ...
     - 실제 서비스 단계에서는 이메일 인증 절차를 추가해, 계정 발급 및 접근을 보다 안전하게 관리할 계획입니다.
  3. Staff 관리 정책 정교화
